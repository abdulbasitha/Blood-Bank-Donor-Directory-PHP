...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        <meta charset="utf-8">
        <title>CONTACT | SPC-IKTHSS CHERUKULAMBA BLOOD DONORS DIRECTORY</title>
                    ...
                    <div class="col-md-3">
                        ...
                        <ul class="contact-info">
                            <li>
                                ...
                                <address>SPC-Ikthss Cherukulamba</address>
                    ...
                    <div class="col-md-3">
                        ...
                        <ul class="contact-info">
                            ...
                            <li>
                                ...
                                <address><a href="#">04933 242 039 </a></address>
                            </li>
                    ...
                    <div class="col-md-3">
                        <ul class="contact-info">
                            <li>
                                ...
                                <address><a href="mailto:">ikthssckb@gmail.com</a></address>
                            </li>
                        </ul>                        
                    ...
                    <div class="col-md-3">
                        ...
                        <ul class="contact-info">
                            <li>
                                ...
                                <address><a href="#">Not Now</a></address>
                            </li>
                        </ul>                        
